            ...
            if(!isset($_GET['my_orders'])){
                if(!isset($_GET['delete_account'])){
                    ...
                    if($row_count>0){
                        ...
                        echo "<h3 class='text-center text-success mt-5 mb-2'>You have 0 pending orders</h3><p class='text-center'><a href='../index.php' class='text-dark'>Explore products</a></p>";
                    }
                }
            }
        }
